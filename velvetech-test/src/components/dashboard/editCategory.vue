<template>
  ...
  >
    <div class="createCategory">
      <span class="createCategory__title">Редактирование категории</span>
...
export default {
  ...
  methods: {
    async editCategory() {
      ...
      const { newName, id } = this;
      const isRes = await this.$store.dispatch("EDIT_CATEGORY", { name: newName, id });
      if (!isRes) {
